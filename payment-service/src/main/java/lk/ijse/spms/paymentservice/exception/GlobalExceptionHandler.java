...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseDTO> handleTransactionNotFoundException(TransactionNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ResponseDTO(HttpStatus.NOT_FOUND.value(), ex.getMessage(), null));
    }

    @ExceptionHandler(PaymentFailedException.class)
    public ResponseEntity<ResponseDTO> handlePaymentFailedException(PaymentFailedException ex) {
